@if ($user)
    ...
    <li class="dropdown user user-menu" style="margin-right: 20px;">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">
            <img src="{{ $user->avatar_url_or_blank ?? 'https://help.github.com/assets/images/help/profile/identicon.png' }}" class="user-image" />
            <span class="hidden-xs">{{ $user->name }}</span>
        </a>
        <ul class="dropdown-menu">
            <!-- User image -->
            <li class="user-header">
                <img src="{{ $user->avatar_url_or_blank ?? 'https://help.github.com/assets/images/help/profile/identicon.png' }}" class="img-circle" />
